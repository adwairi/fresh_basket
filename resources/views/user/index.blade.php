                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="/user" enctype="multipart/form-data" >
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <div class="caption-overflow bg-danger-border">
                                        <img src="{{ $user->img_url?$user->img_url:asset('/system_images/default.png') }}" style="width:150px; hight:150px" class="bg-primary">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
